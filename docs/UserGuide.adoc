...
Making list of according to grade range given by user +
Format: `filterByGrade [minGrade] [maxGrade]`

****
* filter result: list the person's name whose grade within the range.
****
